...
export default () => (
  <section className="px-4 pt-8 md:pt-16 mb-16 md:mb-24">
    <div className="max-w-5xl mx-auto">
      <h1 className="font-black text-3xl sm:text-4xl md:text-5xl mb-4 md:mb-8">
        <span className="relative">
          Hey, I'm Sebastian.
          <Peace
            style={{ strokeWidth: "2" }}
            className="absolute right-0 bottom-0 icon text-3xl sm:text-4xl md:text-5xl text-yellow-600 -mr-8 sm:-mr-10 md:-mr-12 mb-2 sm:mb-3"
          />
        </span>
